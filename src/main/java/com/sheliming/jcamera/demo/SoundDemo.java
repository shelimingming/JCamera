...
public class SoundDemo {
    public static void main(String[] args) throws FrameGrabber.Exception {
        recordWebcamAndMicrophone(0,4,"aaa.mp4",800,600,50);
    }
    /**
     ...
     */
    public static void recordWebcamAndMicrophone(int WEBCAM_DEVICE_INDEX, final int AUDIO_DEVICE_INDEX, String
            outputFile,
